...
class OOBnBTest {
	...
	void setUp() {
		...
		propiedad1 = sistema.aniadirPropiedad("La Casona", "Bien grande", 1, duenio1, new Moderada());
		propiedad2 = sistema.aniadirPropiedad("Procap", "Bing Chilling", 2, duenio2, new Moderada());
		propiedad3 = sistema.aniadirPropiedad("Sistedh", "Turkosone", 2, duenio2, new Moderada());
