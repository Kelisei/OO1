...
public class OOBnB {
	...
	public Propiedad aniadirPropiedad(String nombre, String descripccion, double PrecioPorNoche, Usuario duenio, Politica politica) {
		Propiedad nuevaPropiedad = new Propiedad(duenio, descripccion, PrecioPorNoche, descripccion, politica);
